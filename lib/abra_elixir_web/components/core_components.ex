defmodule AbraElixirWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(AbraElixirWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(AbraElixirWeb.Gettext, "errors", msg, opts)
    end
  end
